        ...
        if (!gameOn) {
            ...
            movement = setInterval(function () {
                ...
                if ((ballX + ballDia) > windowWidth || ballX < 0) {
                    ballSpeedX = -ballSpeedX; // Reverses the direction when struck on wall
                }
                ...
                // Check for Rod 1
                if (ballY <= rod1Height) {
                    ballSpeedY = -ballSpeedY; // Reverses the direction when struck on Rod 1
                    score++;

                    // check if ball passes the Rod 1 then game ends
                ...
                // Check for Rod 2
                    ...
                    ballSpeedY = -ballSpeedY; // Reverses the direction when struck on Rod 2
                    score++;

                    // check if ball passes the Rod 2 then game ends
